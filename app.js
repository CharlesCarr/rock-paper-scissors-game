// Grabbing variables from html elements
...
const getComputerChoice = () => {
  ...
  if (randomNumber === 0) {
    ...
    img.src = "./images/Rock-paper-scissors_(rock).png";
...
const rockBtn = document
  ...
  .addEventListener("click", rockClick);
const paperBtn = document
  .getElementById("paperBtn")
  .addEventListener("click", paperClick);
const scissorsBtn = document
  .getElementById("scissorsBtn")
  .addEventListener("click", scissorsClick);
